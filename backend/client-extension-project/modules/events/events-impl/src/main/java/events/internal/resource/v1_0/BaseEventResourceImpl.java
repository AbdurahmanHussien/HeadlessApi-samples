...
public abstract class BaseEventResourceImpl implements EventResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/events/v1.0/events/{id}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/events/v1.0/events'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Event")}
	)
