...
public abstract class BaseNewsResourceImpl implements NewsResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/News/v1.0/news/{id}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/news/{id}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public NewsArticle getNewsById(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/News/v1.0/news'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
